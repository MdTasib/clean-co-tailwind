...
const Navbar = ({ children }) => {
	const menuItems = (
		<>
			...
			{/* <button data-toggle-theme='dark,light'>Thene</button> */}
		</>
	);

	return (
		<div className='navbar bg-base-100 fixed top-0 z-50 px-20'>
			<div className='navbar-start'>
				...
				<p className='btn btn-ghost normal-case text-xl font-bold'>CLEAN CO</p>
			</div>
